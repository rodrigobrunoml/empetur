                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="#" class="dropdown-item" >Pesquisar</a>
                        </div>
                    </div>
                    -->
                    <a href="#" class="nav-item nav-link"><i class="bi bi-person-bounding-box"></i>Cadastro</a>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="exampleModalLabel">Cadastra novo usuário</h1>
