        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Reserva</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    -->
                    <a href="#" class="nav-item nav-link"><i class="bi bi-cart-check me-2"></i>Reserva</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-scrollable">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="exampleModalLabel">Cadastra novas reservas</h1>
                                ...
                                <form>
                                    <div class="bg-light rounded-top p-4">
                                        <div class="bg-light rounded h-100 p-1">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-5 form-floating mb-2">
                                                    <select class="form-select" id="Status"
                                                        ...
                                                        <option value="1">Gecom Gerada</option>
                                                        <option value="2">Taxa da reserva paga</option>
                                                        <option value="3">Valor total pago</option>
                                                        <option value="4">Politica de fomento</option>
                                                        <option value="5">Evento interno</option>
                                                    </select>
                                                ...
                                                <div class="col-md-1 form-floating mb-2">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="gridCheck">Cancelado</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3">
                                                <div class="col-md-5 form-floating mb-2">
                                                    <select class="form-select" id="TpEvento"
                                                        aria-label="Floating label select example">
                                                        <option selected>Selecione ...</option>
                                                        <option value="1">Congresso</option>
                                                        <option value="2">Convenção</option>
                                                        <option value="3">Conferência</option>
                                                        <option value="4">Curso</option>
                                                        <option value="5">Confraternização</option>
                                                        <option value="6">Desfile</option>
                                                        <option value="7">Exposição</option>
                                                        <option value="8">Encontro</option>
                                                        <option value="9">Espetáculo</option>
                                                        <option value="10">Feira</option>
                                                        <option value="11">Formatura</option>
                                                        <option value="12">Festival</option>
                                                        <option value="13">Lançamento</option>
                                                        <option value="14">Mostra</option>
                                                        <option value="15">Palestra</option>
                                                        <option value="16">Reunião</option>
                                                        <option value="17">Simpósio</option>
                                                        <option value="18">Seminário</option>
                                                        <option value="19">Salão</option>
                                                        <option value="20">Workshoop</option>
                                            ...
                                            <div class="form-floating mb-2">
                                                <input type="nome" class="form-control" id="floatingInput"
                                                    placeholder="Site evento">
                                                <label for="floatingInput">Site evento</label>
                                            </div>
                                            <div class="row g-3">
                                                <div class="col-md-4 form-label mb-2">
                                                    <button type="file" class="btn btn-sm btn-primary"><i class="bi bi-cloud-arrow-up"></i></button>
                                                    <label class="form-check-label">Foto do evento</label>
                                                </div>
                                                <div class="col-md-4 form-label mb-2"></div>
                                                <div class="col-md-4 form-label mb-2"></div>
                                            </div>
                                            <div class="form-floating mb-2">
                                                <textarea class="form-control" placeholder="Observação Operacional"
                                                    id="floatingTextarea" style="height: 150px;"></textarea>
                                                <label for="floatingTextarea">Observação Operacional</label>
                                            </div>
                                            <div class="row g-3">
                                                <div class="col-md-4 form-floating mb-2">
                                                    <input type="date" class="form-control" id="floatingInput"
                                                        placeholder="Data reserva">
                                                    <label for="floatingInput">Data reserva</label>
                                                </div>
                                                <div class="col-md-4 form-floating mb-2">
                                                    <input type="text" class="form-control" id="floatingInput"
                                                        placeholder="Usuário responsável">
                                                    <label for="floatingInput">Usuário responsável</label>
                                                </div>
                                                <div class="col-md-4 form-floating mb-2">
                                                    <input type="nome" class="form-control" id="floatingInput"
                                                        placeholder="Número do contrato">
                                                    <label for="floatingInput">Número do contrato</label>
                                                </div>
                                            </div>
                                            ...
                                            <!-- TABELA DISPONIVEL RESERVA -->
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <h6 class="mb-0">Área Disponivel</h6>
                                            </div>
